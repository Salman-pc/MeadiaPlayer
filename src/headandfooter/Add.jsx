...
function Add({ setaddvideoResponse }) {
  ...
  return (
    <div>
      <div className="d-flex align-items-center h-auto w-100">
        <h3 className="fw-bold text-white fs-5 fs-sm-4 me-3 ">
          UPLOAD VIDEOS
        </h3>
        <button
          onClick={handleShow}
      ...
      >
        ...
        <Modal.Body>
          <p className='text-white'>Please fill the following fields</p>
          <FloatingLabel
            controlId="caption"
            label="Video Caption"
            className="mb-3"
        ...
        <Modal.Footer>
          ...
          <Button className='bg-info border-info' variant="primary" onClick={handleUpload}>Upload</Button>
        </Modal.Footer>
      </Modal>
